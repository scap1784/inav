...
/**
 * Swing component that contains a slider, and title label, and editable text box displaying the
 * slider value.
 * 
...
public class Slider extends JComponent
{
     ...
     */
    public Slider(String title, double min, double max, double value)
    {
     ...
     *            the value associated with the starting slider position
     */
    public Slider(String title, float min, float max, float value)
    {
     ...
     *            the value associated with the starting slider position
     */
    public Slider(String title, int min, int max, int value)
    {
     ...
     *            the value associated with the starting slider position
     */
    public Slider(String title, long min, long max, long value)
    {
     ...
     *            the value associated with the starting slider position
     */
    public Slider(String title, Number min, Number max, Number value)
    {
        m_min = min;
        m_max = max;
        m_value = value;
        m_slider = new JSlider();
        m_label = new JTextField(title);
        ...
        m_field.setPreferredSize(new Dimension(19, 20));
    ...
    protected void initUI()
    {
        ...
        add(m_label, BorderLayout.LINE_START);
        add(m_slider, BorderLayout.CENTER);
        add(m_field, BorderLayout.LINE_END);
    }
    ...
    {
        m_label.setPreferredSize(new Dimension(width, 30));
    }

    public void setFieldWidth(int width)
    {
        m_field.setPreferredSize(new Dimension(width, 30));
    }
    ...
    public void setPreferredSize(Dimension d)
    {
        int fieldWidth = 80;
        int labelWidth = 300;
        int sliderWidth = d.width;
        super.setPreferredSize(d);
        Dimension dd = new Dimension(labelWidth, d.height);
        // m_label.setPreferredSize(dd);
        dd = new Dimension(sliderWidth, d.height);
        m_slider.setPreferredSize(dd);
        dd = new Dimension(fieldWidth, d.height);
